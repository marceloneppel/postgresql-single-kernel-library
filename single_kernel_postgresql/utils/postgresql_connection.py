...
class PostgreSQLConnection:
    ...
    def set_up_login_hook_function(self) -> None:
        ...
        function_creation_statement = SQL("""CREATE OR REPLACE FUNCTION login_hook.login() RETURNS VOID AS $$
DECLARE
	ex_state TEXT;
	ex_message TEXT;
	ex_detail TEXT;
...
$$ LANGUAGE plpgsql;""").format(
    ...
    def set_up_predefined_catalog_roles_function(self) -> None:
        ...
        function_creation_statement = SQL("""CREATE OR REPLACE FUNCTION set_up_predefined_catalog_roles() RETURNS VOID AS $$
DECLARE
    database TEXT;
